...
const WhyWorkWithUs = () => {
    ...
    return (
        <div className='bg-[#F2F2F2] overflow-clip w-full mt-[60px] h-auto flex flex-col lg:flex-row items-center lg:mt-[120px]'>
            <div className='flex-1 h-full w-[100%] bg-[#181A23] inline-block'>
                <div className="px-[50px] py-[100px] md:px-[32px] md:py-[100px]  xl:px-[100px] xl:py-[40px] 2xl:px-[100px] 2xl:py-[100px] min-[1920px]:px-[100px] min-[1920px]:py-[100px]">
            ...
            <div className='flex-1  h-full w-[100%] bg-[#F2F2F2] inline-block'>
                <div className='px-[50px] py-[100px] md:px-[32px] md:py-[100px]  xl:px-[100px] xl:py-[40px] 2xl:px-[100px] 2xl:py-[100px]'>
                    <AnimationOnScroll animateOnce={true} animateIn="animate__backInRight" delay={500}>  <p className=' text-[12px] md:text-[12px] lg:text-[14px] 2xl:text-[18px] min-[1920px]:text-[24px]'> {textItem}</p></AnimationOnScroll>
                </div>
            </div>
        </div>
    )
