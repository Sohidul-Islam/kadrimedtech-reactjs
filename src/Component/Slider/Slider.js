...
const Slider = ({ navItem }) => {
  ...
  let index = 0 ;
  setInterval(()=>{
    let setNewSliderImage = sliderImage;
    index = incrementer(index)
    setNewImage(sliderImage[index])
  },2000)
                    ...
                    <div className="w-[8px] xl:w-[8px] 2xl:w-[8px] rounded-[110px] h-[100px] sm:h-[150px] md:h-[200px] lg:h-[450px] xl:h-[500px] 2xl:h-[570px] bg-[#D9D9D93D]/25">
                      <div
                        className={`w-full h-[33%] ${
                          isActive[0] === 1 ? "bg-[#ffff]" : "bg-transparent"
                        } rounded-md`}
                      ></div>
                      <div
                        className={`w-full h-[33%] ${
                          isActive[1] === 1 ? "bg-[#ffff]" : "bg-transparent"
                        } rounded-md`}
                      ></div>
                      <div
                        className={`w-full h-[33%] ${
                          isActive[2] === 1 ? "bg-[#ffff]" : "bg-transparent"
                        } rounded-md`}
                      ></div>
                    </div>
