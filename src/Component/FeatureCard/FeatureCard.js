...
const FeatureCard = ({feature}) => {
  return (
        <div className={`mx-[50px] bg-[#fff] rounded-[24px] mt-[${feature.id%2===0 ? '-100': '-200'}px]`}>
        <div>
            <div className='flex-col justify-center align-center text-center max-w-[688px] rounded-sm shadow-md p-[40px]'>
