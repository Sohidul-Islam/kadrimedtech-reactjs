...
const Consulting = () => {
    ...
    return (
        <div className='mt-[120px] lg:mx-[90px] w-[90%] mx-auto lg:w-full'>
            <div className='flex flex-wrap items-center flex-col md:flex-row'>
                <div className='text-[24px] md:text-[40px] lg:text-[50px] xl:text-[64px] font-[700] text-center md:mr-[43px] md:my-[16px]  w-full lg:w-[535px] xl:h-[192px] xl:text-left'>
